...
const article = "this is a simple sentence of life";

const recurringLetter = function (article) {
   const newArray = article.split(' ').join('');
    // const list = _(article).toArray().uniq();
    //     console.log(list);
    console.log(newArray);
};

// recurringLetter (article);
