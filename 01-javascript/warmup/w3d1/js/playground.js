...
const ages = function ( second ) {
    const dayTime = 24 * 60 * 60;
    let earthYear = second / 365.25 / dayTime;
    return earthYear;
}
const earth = ages(1000000000);
console.log(earth);

// let x = earth / 0.2408467;
// console.log(x);

const otherAges = function (time, planets ) {
    let planetYear = time / planets;
    return otherAges;
}

console.log(otherAges(earth, 0.2408467));
